...
# DRE - Demonstração do Resultado do Exercício (COMPLETA)
DRE_ACCOUNTS = {
    ...
    "3.08.01": "IR/CS Corrente",
    "3.08.02": "IR/CS Diferido",
    "3.09": "Resultado Líquido das Operações Continuadas",
    "3.10": "Resultado Líquido de Operações Descontinuadas",
    "3.10.01": "Lucro/Prejuízo Líq. Operações Descontinuadas",
    "3.11": "Lucro/Prejuízo Consolidado do Período",
    "3.99": "Lucro por Ação",
    "3.99.01": "Lucro Básico por Ação (ON)",
    "3.99.01.01": "Lucro Básico por Ação (ON) - R$",
    "3.99.02": "Lucro Diluído por Ação (ON)",
    "3.99.02.01": "Lucro Diluído por Ação (ON) - R$",
}

# BPA - Balanço Patrimonial Ativo (COMPLETO)
BPA_ACCOUNTS = {
    "1": "Ativo Total",
    ...
    "1.02.01.03": "Contas a Receber LP",
...
# BPP - Balanço Patrimonial Passivo (COMPLETO)
BPP_ACCOUNTS = {
    "2": "Passivo Total",
    ...
    "2.01.05": "Outras Obrigações CP",
    "2.01.06": "Provisões CP",
    "2.02": "Passivo Não Circulante",
    "2.02.01": "Empréstimos e Financiamentos LP",
    "2.02.02": "Outras Obrigações LP",
    "2.02.03": "Tributos Diferidos Passivo",
    "2.02.04": "Provisões LP",
