...
# ============================================================
# Range dinâmico: tenta de 2010 até o ano corrente.
# Se algum ZIP não existir na CVM, o downloader simplesmente ignora.
from datetime import datetime as _dt

_CURRENT_YEAR = _dt.now().year
_START_YEAR = 2010

DEFAULT_ITR_YEARS = list(range(_START_YEAR, _CURRENT_YEAR + 1))
DEFAULT_DFP_YEARS = list(range(_START_YEAR, _CURRENT_YEAR + 1))
