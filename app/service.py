...
# ============================================================
# Range equilibrado: 7 anos = ~28 trimestres de histórico
# sem estourar memória/tempo no Railway.
# Para mais histórico, aumente gradualmente.
DEFAULT_ITR_YEARS = list(range(2018, 2026))  # 2018 a 2025
DEFAULT_DFP_YEARS = list(range(2018, 2025))  # 2018 a 2024
    ...
    def get_company_financials(
        ...
        for stmt in ["DRE", "BPA", "BPP", "DFC"]:
            ...
            if not df.empty:
                ...
                # Substitui NaN por None (JSON não aceita NaN)
